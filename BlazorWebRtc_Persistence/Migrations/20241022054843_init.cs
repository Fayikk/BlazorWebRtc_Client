    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessagesRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessagesRooms_Users_ReceiverUserId",
                        column: x => x.ReceiverUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MessagesRooms_Users_SenderUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessagesRooms_ReceiverUserId",
                table: "MessagesRooms",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MessagesRooms_SenderUserId",
                table: "MessagesRooms",
                column: "SenderUserId");
